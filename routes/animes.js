...
router.post('/', isAdmin, animesCtrl.create)
// POST http://localhost:3000/catalog/:animeId/reviews
router.post('/catalog/:animeId/reviews', isLoggedIn, animesCtrl.createReview)
// PUT localhost:3000/catalog/:animeId
router.put('/catalog/:animeId', isAdmin, animesCtrl.update)
...
router.delete('/catalog/:animeId/', isAdmin, animesCtrl.delete)
...
router.post('/test', animesCtrl.testSearch)
